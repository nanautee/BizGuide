...
const styles = {
  ...
  inner: "relative z-10 w-full min-w-0 max-w-full overflow-x-hidden px-4 sm:px-8 md:px-12 lg:px-20 xl:px-28",

  title: [
    "mx-auto max-w-full text-balance px-1 text-center font-bold leading-[1.08] text-white",
    "text-[clamp(1.35rem,4.2vw+0.6rem,2.75rem)] sm:text-5xl sm:leading-none md:whitespace-nowrap md:text-6xl lg:text-7xl xl:text-8xl",
  ].join(" "),
  subtitle: [
  ...
  planGoalText: "mt-2 max-w-[920px] text-lg font-light leading-[1.25] text-white md:text-2xl xl:text-3xl",

  stepList: [
    "mt-6 max-w-[880px] space-y-1 border-l-3 border-white/85 pl-2 sm:pl-4",
    "md:mt-8 md:space-y-4",
  ].join(" "),
  stepItem: "flex items-baseline gap-3",
  stepNum: "shrink-0 text-base font-light text-white/90 md:text-lg",
